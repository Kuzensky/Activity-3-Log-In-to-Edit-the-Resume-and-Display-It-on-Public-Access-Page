...
**Q: Why did you implement ID reuse?**
A: To keep IDs compact and organized. In a production system, this prevents very large ID numbers over time and makes testing easier. The algorithm uses PostgreSQL's `generate_series()` to find gaps efficiently.

**Q: Why use vanilla JavaScript instead of a framework?**
A: To demonstrate fundamental JavaScript skills and understanding of the DOM. Frameworks abstract away these concepts, but knowing how to manipulate the DOM directly is important for understanding how web applications work.

**Q: How does the drag-and-drop work?**
A: It uses the HTML5 Drag and Drop API. Each section has `draggable="true"`, and event listeners handle dragstart, dragover, and drop events. The algorithm checks drag direction to insert elements correctly.

**Q: Why use PDO instead of MySQLi?**
A: PDO (PHP Data Objects) is database-agnostic - it works with PostgreSQL, MySQL, SQLite, etc. It also has better prepared statement support and error handling. It's the modern standard for PHP database access.

**Q: How do you prevent SQL injection?**
A: All database queries use prepared statements with placeholders (?). This separates SQL code from user data, so malicious input can't be executed as SQL commands.

### **Files with Best Comments for Review**
1. `controllers/ResumeController.php` - Lines 1-67, 160-229
2. `js/edit_resume.js` - Lines 1-144, 493-577
3. `dashboard.php` - Lines 1-46
